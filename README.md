...
The entire project is run using prompts and alerts for user interaction.
    The main function of the game is called playGame(), it defines the loop for the game, it calls the game round function called gameRound() per ieration count and defines two variables 
